...
void main({
  ...
  WebSocketChannel Function(Uri uri)? devToolsChannelBuilder,
  WebSocketChannel Function(Uri uri)? projectChannelBuilder,
}) {
  ...
  Levit.put(() => ProjectController(connector: projectChannelBuilder));
                        ...
                        children: [
                          ...
                          Positioned.fill(
                            child: GestureDetector(
                              key: const ValueKey('canvas_background'),
