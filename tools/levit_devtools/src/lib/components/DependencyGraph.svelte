<script lang="ts">
    ...
    function buildSimulation() {
        ...
        const nodeIds = new Set<string>(graphState.nodeNames.keys());
        // Also ensure nodes from edges are included (redundant but safe)
        graphState.edges.forEach((e) => {
    ...
    let filteredNodes = $derived.by(() => {
        ...
        // Ensure simulation is updated if node count changes significantly
        // This is a side-effect, but needed for d3
        return nodes;
    });
