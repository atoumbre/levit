...
void main() { setUp(() { Levit.reset(force: true); });
  test('LevitTasksMixin engine.config on double init', () { final controller = TestController(); controller.didAttachToScope(Ls.currentScope, key: 'test'); controller.onInit(); controller.onInit(); });
}