...
Because:
* `package:levit_flutter/levit_flutter.dart` that imports:
...
```
Because levit_flutter depends on levit_flutter_core any which doesn't exist (could not find package levit_flutter_core at https://pub.dev), version solving failed.
```
