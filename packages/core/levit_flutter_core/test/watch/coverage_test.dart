...
void main() {
  ...
  testWidgets('LWatch slow path subscription churn', (tester) async {
    ...
    // Now verify Lx + Stream integration (Input Bridge path)
    // This still works because Lx handles the stream internally and notifies LWatch via Notifier.
    ...
    // Test removal of dependency when switching back to a static view
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: LWatch(() {
