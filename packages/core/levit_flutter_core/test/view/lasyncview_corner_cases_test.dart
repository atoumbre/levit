...
void main() {
  testWidgets('LAsyncView.store coverage', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        home:
            LAsyncView.store(state, builder: (context, value) => Text(value))));
  ...
  testWidgets('LAsyncView didUpdateWidget', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        home: LAsyncView<String>(
            resolver: resolver1, builder: (context, value) => Text(value))));
    await tester.pumpAndSettle();
    expect(find.text('val1'), findsOneWidget);
    await tester.pumpWidget(MaterialApp(
        home: LAsyncView<String>(
            resolver: resolver2, builder: (context, value) => Text(value))));
    await tester.pumpAndSettle();
  ...
  testWidgets('LAsyncScope + LView.store coverage', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        home: LAsyncScope(
            ...
            child:
                LView.store(state, builder: (context, value) => Text(value)))));
    await tester.pumpAndSettle();
  ...
  testWidgets('LWatchStatus lifecycle and context', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
        home: LStatusBuilder<String>(rx,
            onSuccess: (data) => Text('Data: $data'),
            onIdle: () => const Text('Idle'))));
    expect(find.text('Idle'), findsOneWidget);
  });
  testWidgets('LAsyncView autoWatch: false', (tester) async {
    await tester.pumpWidget(MaterialApp(
        home: LAsyncView<String>(
  ...
  testWidgets('LevitBuildContextExtensions global fallback', (tester) async {
