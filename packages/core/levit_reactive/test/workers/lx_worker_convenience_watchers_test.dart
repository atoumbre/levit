...
void main() {
  test('Convenience watchers: isTrue, isFalse, isValue', () {
    ...
    var trueCount = 0; var falseCount = 0; var valueCount = 0;

    LxWorker.watchTrue(boolRx, () => trueCount++);
    LxWorker.watchFalse(boolRx, () => falseCount++);
    LxWorker.watchValue(intRx, 5, () => valueCount++);

    boolRx.value = true; expect(trueCount, 1);
    boolRx.value = false; expect(falseCount, 1);

    intRx.value = 3; intRx.value = 5; expect(valueCount, 1);
  });
}
