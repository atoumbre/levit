...
void main() {
  test('LxStatus convenience watcher', () {
    ...
    statusRx.value = LxWaiting(); expect(stage, 'waiting');
    statusRx.value = LxSuccess(10); expect(stage, 'success 10');
    statusRx.value = LxError('fail'); expect(stage, 'error fail');
  });
}
