...
class CoverageMiddleware extends LevitReactiveMiddleware {
  int startCount = 0; int stopCount = 0; LxListenerContext? lastContext;
  @override void Function(LxReactive, LxListenerContext?)? get startedListening => (r, c) { startCount++; lastContext = c; };
  @override void Function(LxReactive, LxListenerContext?)? get stoppedListening => (r, c) { stopCount++; lastContext = c; };
}
...
void main() {
  test('runWithContext logic and middleware hooks', () {
    ...
    final ctx = const LxListenerContext(type: 'Test', id: 1, data: {'key': 'val'});
    Lx.runWithContext(ctx, () {
      final v = LxVar(0); v.addListener(() {});
    });
    ...
    mw.startCount = 0; mw.lastContext = null;
    ...
    mw.stopCount = 0; mw.lastContext = null;
